...
public class Strings {
    ...
    public void stringsWork(BufferedReader reader) throws IOException {
    ...
    public void isEqualStrings(String str1, String str2) {
        if (str1.equals(str2)) System.out.println("Strings are equals.");
        else System.out.println("Sorry, they are not equals ):");
    }

    public void modificatedStrings(String str1, String str2) {
        str1.toLowerCase();
        str2.toLowerCase();
        str1.trim();
        str2.trim();
    ...
    public void isOverturned(String str1, String str2) {
        ...
        for (int i = 0, j = str2.length() - 1; i < str2.length() / 2; i++, j--) {
            ...
            else System.out.println("They are overturned!");
        }

    }

    public void isEmail(String str1, String str2) {
        ...
        else System.out.println("" + str1 + " is not an email.");

        if (matStr2.matches()) System.out.println("" + str2 + " is an email.");
        else System.out.println("" + str2 + " is not an email.");
    }


    public void isPhoneNumber(String str1, String str2) {
        ...
        else System.out.println("" + str1 + " is not a phone number.");

        if (matStr2.matches()) System.out.println("" + str2 + " is a phone number.");
        else System.out.println("" + str2 + " is not a phone number.");
    }

    public void isIP(String str1, String str2) {
        ...
        else System.out.println("" + str1 + " is not an IP");

        if (matStr2.matches()) System.out.println("" + str2 + " is an IP");
        else System.out.println("" + str2 + " is not an IP.");
    }
}
